...
#        H, xedges, yedges = np.histogram2d( dumDense, dumTemp, bins=numbins)
#        for i in range(0,numbins):
#            for j in range(0,numbins):
#                H[i][j] = 0.
...
#                n = denseBins[j]
#                t = tempBins[k]
#            if nH>-6 and nH<-3 and t>4 and t<5:
#                print nH, t, cellMass, H[denseInd][tempInd]
...
plt.tight_layout()
s = dataLoc+'abscell_phase.master.mass.pdf'
